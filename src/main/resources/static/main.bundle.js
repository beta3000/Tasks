...
var TasksAddComponent = (function () {
    ...
    TasksAddComponent.prototype.onTaskAdd = function ($event) {
        var _this = this;
        var task = new __WEBPACK_IMPORTED_MODULE_2__task_model__["a" /* Task */](null, event.currentTarget.value, this.getTodayAsString(), false);
        debugger;
...
var TasksListComponent = (function () {
    ...
    TasksListComponent.prototype.onTaskChange = function ($event, task) {
        this.taskService.saveTask(task, event.currentTarget.checked)
            .subscribe();
    };
